 ...
 */
@WebServlet(name = "FaqFileDown", urlPatterns = { "/faqFileDown.do" })
public class FaqFileDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FaqFileDownServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.인코딩
				...
				String downFile = root+"upload/faq/"+f.getFilepath();//실제업로드된 이름이 필요하므로 filepath
