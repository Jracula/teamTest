...
public class OneOnOneService {
	...
	public OneOnOnePageData selectOneOnOneList(int reqPage) {
		...
		if(pageNo != 1) {
			pageNavi += "<li>";
			pageNavi += "<a class='page-item' href='/oneOnOneList.do?reqPage="+(pageNo-1)+"'>";
		...
		for(int i=0; i<pageNaviSize; i++) {
			if(pageNo == reqPage) {
				pageNavi += "<li>";
				pageNavi += "<a class='page-item active-page' href='/oneOnOneList.do?reqPage="+(pageNo)+"'>";
				pageNavi += pageNo;
				pageNavi += "</a></li>";
			}else {
				pageNavi += "<li>";
